...
.deferredfeedback .qtext {
	font-weight: bold!important;
	color: green!important;
	font-size: 19px!important;
}
.deferredfeedback .ablock {
	font-weight: 600!important;
}
.deferredfeedback .answer input[type="radio"] {
	display: none!important;
}
.deferredfeedback .answer input[type="radio"] + *::before {
  content: "";
...
.deferredfeedback .answer input[type="radio"]:checked + *::before {
  background: radial-gradient(teal 0%, teal 40%, transparent 50%, transparent);
  border-color: teal;
}
.deferredfeedback .answer input[type="radio"]:checked + * {
  color: teal;
}
